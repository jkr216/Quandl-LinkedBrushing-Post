...
chosenFreq <- eventReactive(input$go, {
  names(frequencyChoices[frequencyChoices == input$frequency])
})
...
commodity <- Quandl(input$dataSet,
  ...
  # how to handle the start date? 
 # tk_ts(start = c(2008), freq = input$frequency)
